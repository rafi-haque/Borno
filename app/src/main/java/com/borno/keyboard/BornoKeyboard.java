...
public class BornoKeyboard extends Keyboard {
    ...
    public BornoKeyboard(Context context, int xmlLayoutResId) {
        super(context, xmlLayoutResId);
    }

    public BornoKeyboard(Context context, int layoutTemplateResId,
    ...
    protected Key createKeyFromXml(Resources res, Row parent, int x, int y,
        ...
        } else if (key.codes[0] == BornoKeyboardView.KEYCODE_LANGUAGE_SWITCH) {
